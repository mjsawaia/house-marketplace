...
const EditListing = () => {
  ...
  // fetch listing to populate form/edit
  useEffect(() => {
    setLoading(true);
  ...
  const onSubmit = async (e) => {
    ...
    if (geolocationEnabled) {
      const response = await fetch(
        `https://maps.googleapis.com/maps/api/geocode/json?address=${address}&key=${process.env.REACT_APP_MAP_API_KEY}`
      );
